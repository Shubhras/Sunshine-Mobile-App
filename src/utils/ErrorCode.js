export const ErrorCode = {
  ...
  emailPasswordNotFound: 'emailPasswordNotFound',
};
...
export const localizedErrorMessage = errorCode => {
  switch (errorCode) {
    ...
    case ErrorCode.emailPasswordNotFound:
      return 'Please enter email and password first';
    ...
    default:
      return 'An error came up while logging you in. Please try again. Error code: ' + errorCode;
  }
};
