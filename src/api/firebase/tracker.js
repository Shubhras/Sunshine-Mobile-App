...
// import { channelManager } from "../../Core/chat/api/";
import { loginUser } from '../../redux/slices/SessionUser'
import {  setSwipes,
  setMatches,
  setIncomingSwipes,
  setSwipesListenerDidSubscribe, } from '../../redux/slices/datingSlice';
...
export default class SwipeTracker {
  ...
  updateUsers = users => {
    ...
    this.reduxStore.dispatch(loginUser(this.users))
    this.hydrateSwipes()
  }
